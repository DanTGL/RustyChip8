...
impl CPU {
    ...
    pub fn execute_opcode(&mut self) {
        ...
        let op1 = self.memory[self.program_counter as usize + 1];
        let op2 = self.memory[self.program_counter as usize];
        ...
        match (op1 & 0xF0) >> 4 {
            ...
            0x1 => self.program_counter = nnn(op1, op2),
            ...
            0x7 => self.registers[X as usize] += op2,
            0x8 => match op2 & 0xF {
            ...
            0xD => todo!("Implement display functionality"),
            _ => println!("Unimplemented opcode: 0x{:x}{:x}", op1, op2)
        }
